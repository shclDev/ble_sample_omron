...
public class HistoryData implements Parcelable {
    ...
    public LinkedList<Map<OHQMeasurementRecordKey, Object>> getMeasurementRecords() {
        ...
        //For SpO2, the memory data and spot data may not be in order of measurement date and time, so sort the data.
        if (OHQDeviceCategory.PulseOximeter.equals(getDeviceCategory())){
            Collections.sort(ret, new Comparator<Map<OHQMeasurementRecordKey, Object>>(){
                @Override
                public int compare(Map<OHQMeasurementRecordKey, Object> rec1, Map<OHQMeasurementRecordKey, Object> rec2) {
                    String colName1 = (String)rec1.get(OHQMeasurementRecordKey.TimeStampKey);
                    String colName2 = (String)rec2.get(OHQMeasurementRecordKey.TimeStampKey);
                    if (colName1 == null){
                        colName1 = "";
                    }
                    if (colName2 == null){
