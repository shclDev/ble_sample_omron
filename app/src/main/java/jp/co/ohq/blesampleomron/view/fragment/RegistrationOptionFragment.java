...
public class RegistrationOptionFragment extends BaseFragment {
    ...
    private static final String ARG_IS_SIRIUS = "ARG_IS_SIRIUS";
    ...
    public static RegistrationOptionFragment newInstance(int numberOfUser, DiscoveredDevice device) {
        ...
        boolean isBluetoothStandardMode = false;
        if (null != device.getEachUserData()) {
            isBluetoothStandardMode = device.getEachUserData().isBluetoothStandardMode();
        }
        args.putBoolean(ARG_IS_SIRIUS, isBluetoothStandardMode);
    ...
    public View onCreateView(
        ...
        boolean isBluetoothStandardMode = args.getBoolean(ARG_IS_SIRIUS);
        ...
        if (1 <= numberOfUser && !isBluetoothStandardMode) {
